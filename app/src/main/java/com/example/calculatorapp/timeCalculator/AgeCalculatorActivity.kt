package com.example.calculatorapp.timeCalculator
...
class AgeCalculatorActivity : AppCompatActivity() {
    var birth_month_value = 1
    var birth_day_value = 1
    var birth_year_value = 2000
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        current_month_value = cMonth
        current_day_value = cDay
        current_year_value = cYear
        ...
        birth_dateSelect.setOnClickListener {
            val bottomSheet = BottomSheetDialog(this@AgeCalculatorActivity,
        ...
        linearLayout2.setOnClickListener {
            ...
            view.year_answer.text=ageInYears.toString()
            view.month_answer.text=ageInMonths.toString()
            view.day_answer.text=ageInDays.toString()
