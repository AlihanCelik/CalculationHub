        ...
        try {
            ...
            result = scriptEngine?.eval(
                temp.replace("%".toRegex(), "/100")
                    .replace("x".toRegex(), "*")
                    .replace("÷".toRegex(), "/")
                    .replace("sin\\(".toRegex(), if (isDegreeEnable) "Math.sin(toRadians(" else "Math.sin(")
                    .replace("cos\\(".toRegex(), if (isDegreeEnable) "Math.cos(toRadians(" else "Math.cos(")
                    .replace("abs\\(".toRegex(), "Math.abs(")
                    .replace("tan\\(".toRegex(), if (isDegreeEnable) "Math.tan(toRadians(" else "Math.tan(")
                    .replace("arcsin\\(".toRegex(), if (isDegreeEnable) "Math.asin(toRadians(" else "Math.asin(")
                    .replace("arccos\\(".toRegex(), if (isDegreeEnable) "Math.acos(toRadians(" else "Math.acos(")
                    .replace("arctan\\(".toRegex(), if (isDegreeEnable) "Math.atan(toRadians(" else "Math.atan(")
