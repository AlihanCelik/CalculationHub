...
import kotlinx.android.synthetic.main.activity_body_fat_percentage_calculator.*
...
class BodyFatPercentageCalculatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        weightSelect.setOnClickListener {
            ...
            val bottomSheet =
                BottomSheetDialog(this@BodyFatPercentageCalculatorActivity, R.style.BottomSheetDialogTheme)
